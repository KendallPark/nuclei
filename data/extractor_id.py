...
def extraction(extraction_rate=0.1, stage_1_train_classes_csv="stage1_train_classes.csv", stage1_train_folder="stage1_train", seed=1):
    if not os.path.exists(stage_1_train_classes_csv):
        raise IOError("Make sure you have " + stage_1_train_classes_csv)
    ...
    pd_data = shuffle(pd_data_origin, random_state = seed)
...
if __name__ == "__main__":
    print(extraction(0.1, "stage1_train_classes.csv", "stage1_train", 1))
