...
COCO_WEIGHTS_PATH = os.path.join(THIS_DIR, "mask_rcnn_coco.h5")

# Directory to save logs and model checkpoints, if not provided
# through the command line argument --logs
DEFAULT_LOGS_DIR = os.path.join(THIS_DIR, "logs")
...
VAL_IMAGE_IDS = extraction(0.1, os.path.abspath("../data/stage1_train_classes.csv"), os.path.abspath("../data/stage1_train"))
